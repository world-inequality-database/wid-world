...
// Generate data quality column for macro variables
* So far, all the data called here belongs to the WITD or to Piketty Wucman 2013, therbore both of them come from scientific papers and as so, the macreconomic data can be set by default as 
*gen data_quality=5 if p=="pall"
