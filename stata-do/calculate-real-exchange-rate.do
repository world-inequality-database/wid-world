...
gen     valuexrerus999i= xlcusp999i/xlcusx999i
gen     data_qualityxrerus999i= min(data_qualityxlcusp999i,data_qualityxlcusx999i)   
gen     s_xrerus999i= "xlcusp/xlcusx"        

* Gen real exchange rate for EUR
gen     valuexrereu999i= xlceup999i/xlceux999i 
gen     data_qualityxrereu999i= min(data_qualityxlceup999i, data_qualityxlceux999i) 
gen     s_xrereu999i= "xlceup/xlceux"   

* Gen real exchange rate for CNY
gen     valuexreryu999i= xlcyup999i/xlcyux999i  
gen     data_qualityxreryu999i= min(data_qualityxlcyup999i, data_qualityxlcyux999i ) 
gen     s_xreryu999i= "xlcyup/xlcyux"
...
preserve
	...
	append using "$work_data/merge-historical-aggregates-metadata.dta"
...
preserve
	* Import Data
	use "$work_data/nievaspiketty2025_xrerus.dta", clear
	
	* Complete data for missing regions
...
restore
merge m:1 iso year using "`xratereal'"
*/
//-----------------------------------------------------------------------------	
...
*Add to the WID
gen calc=1
append using "$work_data/merge-historical-aggregates-output.dta"

* Verification
duplicates tag year iso widcode p, gen(dup)
drop if calc!=1 & dup==1
