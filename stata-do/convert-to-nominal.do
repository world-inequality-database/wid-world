...
// Germany: use contemporary euros for the whole series
replace value = value/1e12 if iso == "DE" & inlist(widcode, "inyixx999i", "icpixx999i") & year < 1924
replace value = value/1e12 if iso == "DE" & inlist(substr(widcode, 1, 1), "a", "m", "t") & year < 1924
