...
foreach v in  ptxgo comhn nmxho nmxhn fkpin confc {
	gen s_`v'       = "Bauluz2019" // https://wid.world/document/revised-national-income-wealth-australia-canada/
	gen q_`v' = 4
}

generate series = 300000

label data "Generated by import-income-researchers.do"
