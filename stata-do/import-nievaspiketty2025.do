...
preserve
	...
	rename iso region2
	label data "Generated by import-nievaspiketty2025.do"
	save "$work_data/nievaspiketty2025_gdp-reg.dta", replace
restore
/*
*Export Price-index
preserve
...
*Export Xrate
preserve
	keep if inlist(origin,"I1g")
	drop origin concept
	rename value xrerus_np
	save "$work_data/nievaspiketty2025_xrerus.dta", replace
restore
...
*Export GDP
preserve
	keep if year<1971 | (year<1981 & inlist(iso,"TW")) 
	...
	save "$work_data/nievaspiketty2025_gdp.dta", replace
...
preserve
	...
	drop origin concept
	rename value def_np
	save "$work_data/nievaspiketty2025_deflactor.dta", replace
restore
...
preserve
	...
	save "$work_data/nievaspiketty2025_xrate.dta", replace
restore
...
replace  widcode= "ytgncx999i" if origin =="B2a"  // new May 2025
replace  widcode= "ytgxcx999i" if origin =="B2b"  // new May 2025
replace  widcode= "ytgmcx999i" if origin =="B2c"  // new May 2025
replace  widcode= "ytgnmx999i" if origin =="B3a"  // new May 2025
replace  widcode= "ytgxmx999i" if origin =="B3b"  // new May 2025
replace  widcode= "ytgmmx999i" if origin =="B3c"  // new May 2025
...
*replace  widcode= "xrerus999i" if origin =="I1g"   // new May 2025 Not necessary, Completely calculated in the code
